        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="mt-0 header-title">Edit Supplier</h3>
                    <p class="sub-title">
                    </p>
                    @if ($errors->any())
                    ...
                    <form id="formStoreKaryawan" method="POST" action="{{ route('suppliers.update', $supplier->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row text-right">
                            <div class="col-md-12">
                                <a id="btnBatalEditSupplier" href="{{ route('suppliers.index') }}"
                                    class="btn btn-danger btn-lg waves-effect waves-light mr-3">Batal</a>
                                <button id="btnEditSupplier" type="submit"
