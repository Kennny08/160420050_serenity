        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="mt-0 header-title">Edit Karyawan {{ $karyawan->nama }}</h3>
                    <p class="sub-title">
                    </p>
                    @if ($errors->any())
                    ...
                    <form id="formUpdateKaryawan" method="POST" action="{{ route('karyawans.update', $karyawan->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="btn-group btn-group-toggle border w-100" data-toggle="buttons">
                                    @if ($karyawan->jenis_karyawan == 'pekerja salon')
