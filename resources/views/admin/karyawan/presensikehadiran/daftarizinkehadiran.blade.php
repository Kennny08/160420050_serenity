        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="grupAktif">
                    ...
                    @if (count($daftarIzinPresensiHariIniKedepan) > 0 && count($daftarIzinPresensiHariSebelumnya) > 0)
                    ...
                    @if (count($daftarIzinPresensiHariIniKedepan) > 0)
                        @if (count($daftarIzinPresensiHariIniKedepan) > 0 && count($daftarIzinPresensiHariSebelumnya) == 0)
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <h4>Daftar Izin Kehadiran Hari Ini dan Kedepannya</h4>
                    ...
                    <div class="table-responsive">
                        <table id="tabelDaftarRiwayatIzinKehadiranSebelumnya"
                            ...
                            <tbody id="bodyTableDaftarIzinHariSebelumnya">
                                @if (count($daftarIzinPresensiHariSebelumnya) > 0)
                                ...
                                @else
                                    <tr class="text-center">
                                        <td colspan="7">
                                            Tidak ada riwayat izin kehadiran karyawan!
                                        </td>
                                    </tr>
                                @endif
        ...
        $(document).ready(function() {
            $('#tabelDaftarRiwayatIzinKehadiranHariIniKedepan').DataTable({
                ...
                language: {
                    ...
                    infoEmpty: "Tidak terdapat Daftar Izin Karyawan untuk hari ini dan kedepannya!",
                }
            });
            ...
            $('#tabelDaftarRiwayatIzinKehadiranSebelumnya').DataTable({
                ...
                language: {
                    ...
                    infoEmpty: "Tidak terdapat Daftar Riwayat Izin Kehadiran Karyawan!",
                }
            });
        });
