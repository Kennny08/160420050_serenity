...
{{ $produk->deskripsi }}
                        ...
                        <div class="form-group row" id="containerKeteranganKondisi">
                                ...
                                <div class="input-group" style="width: 100%">
                                    <select style="width: 70%" name="kondisi" id="selectKondisi" class="form-control"
                                        ...
                                        @foreach ($kondisis as $kondisi)
                                            @if (!in_array($kondisi->id, $arrayIdKondisi))
                            ...
                            @foreach ($produk->kondisis as $kondisi)
                                <input id='kondisi{{ $kondisi->id }}' type='hidden' class='classarraykondisiid'
                                    value='{{ $kondisi->id }}' name='arraykondisiid[]'>
                            @endforeach
                        </div>
                        ...
                        <div class="form-group row text-right">
                            <div class="col-md-12">
                                <a id="btnBatalEditProduk" href="{{ route('produks.index') }}"
