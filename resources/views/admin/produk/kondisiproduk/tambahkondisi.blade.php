...
@section('title', 'Admin || Tambah Keterangan Kondisi')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="mt-0 header-title">Tambah Keterangan Kondisi untuk Produk</h3>
                    <p class="sub-title">
                    </p>
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('kondisis.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="keteranganKondisi" id="textNamaKondisi"
                        ...
                        <div class="form-group text-right">
                            <div class="col-md-6">
                                <a id="btnBatalTambahKondisi" href="{{ route('kondisis.index') }}"
                                    class="btn btn-danger btn-lg waves-effect waves-light mr-3">Batal</a>
                                <button id="btnTambahKondisi" type="submit"
