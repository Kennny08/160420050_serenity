...
@section('title', 'Admin || Edit Merek Produk')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="mt-0 header-title">Edit Merek Produk</h3>
                    <p class="sub-title">
                    </p>
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('mereks.update', $objMerek->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="namaMerek" id="textNamaMerek" value="{{ $objMerek->nama }}"
                                    aria-describedby="emailHelp" placeholder="Silahkan masukkan Merek Produk" required>
