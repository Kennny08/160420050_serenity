...
@section('title', 'Karyawan || Daftar Riwayat Penjualan')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="mt-0 header-title" id="grupAktif">Daftar Riwayat Penjualan tanpa Penjualan</h3>
                    <p class="sub-title">
                    </p>
                    <br>
                    @if (session('status'))
...
@section('javascript')
    <script>
        ...
        $('body').on('click', '.btnDetailPenjualanPerTanggal', function() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route('penjualans.karyawan.getdetailriwayatpenjualan') }}',
                data: {
