...
<head>
    ...
    <style>
        ...
        .radio-indicator {
            ...
            border: 2px solid #273ED4;
            border-radius: 50%;
        }

        .radio-container input:checked+.radio-indicator {
                            ...
                            <div class="col-lg-7 col-md-12 ml-auto mr-auto">
                                <div class="login-register-wrapper">
                                    <div class="login-register-tab-list nav">
                                        ...
                                        <a class="active" href="{{ route('pelanggans.bukaregister') }}">
                                            <h4>register</h4>
                                        </a>
                                    </div>
                                    @if ($errors->any())
                                        ...
                                        <div id="lg2" class="tab-pane active">
                                            <div class="login-form-container">
                                                <div class="login-register-form">
                                                    <form action="{{ route('pelanggans.register') }}" method="post">
                                                        @csrf
                                                        <label class="fw-bold h6"
                                                            style="margin-bottom: 20px;">Nama</label>
                                                        <input style="border-radius: 5px;font-size: 1.1em;"
                                                            type="text" placeholder="Masukkan Nama Pelanggan"
                                                            name="nama" value="{{ old('nama') }}">

                                                        <label class="fw-bold h6"
                                                            style="margin-bottom: 20px;">Alamat</label>
                                                        <input style="border-radius: 5px;font-size: 1.1em;"
                                                            type="text" placeholder="Masukkan Alamat Pelanggan"
                                                            name="alamat" value="{{ old('alamat') }}">

                                                        <label class="fw-bold h6" style="margin-bottom: 20px;">Tanggal
                                                            Lahir</label>
                                                        <input style="border-radius: 5px;font-size: 1.1em;"
                                                            type="date" placeholder="TanggalLahir"
                                                            name="tanggallahir" value="{{ old('tanggallahir') }}">

                                                        <label class="fw-bold h6" style="margin-bottom: 20px;">Jenis
                                                            Kelamin</label>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label class="radio-container">
                                                                    <p style="font-size: 1.1em;">Pria</p>
                                                            ...
                                                            <div class="col-md-4">
                                                                <label class="radio-container">
                                                                    <p style="font-size: 1.1em;">Wanita</p>
                                                                    <input type="radio" name="gender"
                                                                        value="wanita">
                                                                    <span class="radio-indicator"></span>
                                                                </label>
                                                        ...
                                                        <label class="fw-bold h6" style="margin-bottom: 20px;">Nomor
                                                            Telepon</label>
                                                        <input style="border-radius: 5px;font-size: 1.1em;"
                                                        ...
                                                        <label class="fw-bold h6"
                                                            style="margin-bottom: 20px;">Email</label>
                                                        <input style="border-radius: 5px;font-size: 1.1em;"
                                                            type="email" placeholder="Masukkan Email Pelanggan"
                                                        ...
                                                        <label class="fw-bold h6"
                                                            style="margin-bottom: 20px;">Password</label>
                                                        <input style="border-radius: 5px;font-size: 1.1em;"
                                                            type="password" placeholder="Masukkan Password"
                                                            name="password">
                                                        <div class="button-box">
                                                            <button type="submit"
                                                                style="float: right; border-radius: 5px;"><span>Register</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
