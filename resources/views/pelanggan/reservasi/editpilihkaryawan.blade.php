        ...
        <div class="col-12">
            <div>
                <div class="card-body">
                    ...
                    <h4 class="fw-bold">Edit Pemilihan Karyawan</h4>
                    <p class="sub-title">
                    </p>
                    @php
                        $keteranganNull = 0;
            ...
            @endif --}}
                    ...
                    <form method="POST" action="{{ route('reservasis.pelanggan.konfirmasieditpilihkaryawan') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="hiddenIdReservasi" value="{{ $idReservasi }}">
                        <div class="mb-2">
                            ...
                            <div class="d-inline-block ml-5px">
                                <button style="font-size: 20px" type="button"
                                    class="btn waves-effect waves-light custom-tooltip" data-bs-toggle="tooltip"
                                                        ...
                                                        <div class="billing-info-wrap">
                                                            <div class="billing-select">
                                                                <select required
                                                                    ...
                                                                    class="selectkaryawan allkaryawan"
                                                        ...
                                                        <div class="billing-info-wrap">
                                                            <div class="billing-select">
                                                                <select required class="selectkaryawan allkaryawan"
                                                                    style="border-radius: 3px;" name="selectkaryawan[]">
                                                                    @if (count($ps['karyawans']) == 0)
                                                                        <option selected value="-">Tidak Tersedia
                                                                            Karyawan
                                                                        </option>
                                                                    @else
                                                                        <option disabled selected value="null">Pilih
                                                                            Karyawan
                                                                        </option>
                                                ...
                                                <tr class="text-center align-middle">
                                                    ...
                                                    <td>
                                                        @if (in_array($ps['perawatan']->id, $arrPerawatanTidakPerluBerubah))
                                                            <div class="billing-info-wrap">
                                                                <div class="billing-select">
                                                                    <select required
                                                                        style="background-color: #e0e0e0; border-radius: 3px;"
                                                                        class="selectkaryawankomplemen allkaryawan"
                                                        ...
                                                        @else
                                                            <div class="billing-info-wrap">
                                                                <div class="billing-select">
                                                                    <select required style="border-radius: 3px;"
                                                                        class="selectkaryawankomplemen allkaryawan"
                            ...
                            <div class="col-md-2 col-sm-12 col-xs-12 form-group text-left" >
                                <div class="product-details-content quickview-content">
                                    <div class="pro-details-quality" style="padding: 0px; margin: 0px;">
                                        <div class="pro-details-cart" style=" display: flex; align-items: center; ">
                                            <button id="btnBackDetailReservasi" class="add-cart" onclick="goBack()"
                                                type="button" style="margin: 0px; width: 100%";>
                                                <span><i class="fa fa-arrow-left"
                                                        aria-hidden="true"></i>&nbsp;&nbsp;Detail Reservasi</span>
