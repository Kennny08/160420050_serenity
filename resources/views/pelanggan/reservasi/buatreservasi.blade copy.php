        ...
        <div class="col-12">
            <div>
                <div class="card-body">
                    ...
                    <h3 class="mt-0 header-title">Buat Jadwal Reservasi</h3>
                    <p class="sub-title">
                    </p>
                    @if ($errors->any())
                            ...
                            <div class="form-group col-md-12 table-responsive">
                                <div>
                                    <table class="table table-bordered table-striped dt-responsive wrap">
                                        ...
                                        <tbody id="bodyListPerawatan" style="text-align: center;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2 ">
                                <div class="product-details-content quickview-content">
                                    <div class="pro-details-quality" style="padding: 0px;margin: 0px;">
                                        <div class="pro-details-cart ml-auto" style="width: 100%;">
                                            <button id="btnKonfirmasiPerawatan" type="button" data-bs-toggle = "modal"
                                                data-bs-target="#modalKonfirmasiPerawatan" class="add-cart "
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <div class="product-details-content quickview-content">
                                            <div class="pro-details-quality" style="padding: 0px;margin: 0px;">
                                                <div class="pro-details-cart ml-auto" style="width: 100%;">
                                                    <button id="btnPilihKaryawan" type="button" data-bs-toggle = "modal"
                                                        data-bs-target="#modalKonfirmasiPerawatan" class="add-cart "
        ...
        $('body').on('click', '#btnTambahLayanan', function() {
            ...
            if (perawatanid != null) {
                ...
                $("#bodyListPerawatan").append(
                    ...
                    "<td class='product-wishlist-cart '>" +
                    "<button type='button' style='width:100px;height:30px; border-radius:3px;' class='deletePerawatan btn-danger waves-effect waves-light' idPerawatan='" +
                    perawatanid +
