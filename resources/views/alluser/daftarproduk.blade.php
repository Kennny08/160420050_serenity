    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                <form action="{{ route('produks.daftarprodukfilteralluser') }}" method="POST">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                                    ...
                                    <div class="shop-top-bar d-flex">
                                        <!-- Left Side start -->
                                        <p><span>{{ count($produksJualAktif) }}</span>&nbsp; Produk ditemukan dari
                                            &nbsp;<span>{{ $totalProduk }}</span></p>
                                        <!-- Left Side End -->
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade " id="shop-grid">
                                                        <div class="row mb-n-30px">
                                                            ...
                                                            @foreach ($produksJualAktif as $produk)
                                                                    ...
                                                                    <div class="product">
                                                                        <div class="thumb">
                                                                            <a href="{{ route('produks.detailprodukalluser', $produk->id) }}"
                                                                                class="image">
                                                                                <img src="{{ asset('assets_admin/images/produk/' . $produk->gambar) }}"
                                                                        ...
                                                                        <div class="content">
                                                                            ...
                                                                            <h4 ><a class="text-dark"
                                                                                    href="{{ route('produks.detailprodukalluser', $produk->id) }}">{{ $produk->nama }}
                                                                                </a>
                                                                            </h4>
                                                                            <span class="price">
                                                                                <span class="new">Rp.
                                                                    ...
                                                                    <div class="col-md-7 col-lg-7 col-xl-8">
                                                                        <div class="content-desc-wrap">
                                                                            <div class="content">
                                                                                ...
                                                                                <h4><a class="text-dark"
                                                                                        href="{{ route('produks.detailprodukalluser', $produk->id) }}">{{ $produk->nama }}</a>
                                                                                </h4>
                                                                                @if (strlen($produk->deskripsi) > 150)
                                                                                    <p>{{ substr($produk->deskripsi, 0, 150) }}...
                                                                                    </p>
                                                                                @else
                                    ...
                                    <div class="shop-sidebar-wrap">
                                        ...
                                        <div class="sidebar-widget-search">
                                            <div id="widgets-searchbox">
                                                ...
                                                @else
                                                    <input name="kataKunci" class="input-field" type="text"
                                                        placeholder="Cari Produk" value="{{ $kataKunci }}">
                                                @endif
                                            ...
                                            <div class="sidebar-widget-category">
                                                <ul>
                                                    @foreach ($kategoris as $kategori)
                                                        @if ($kategori->id == $kategoriTerpilih)
                                                            <li><button type="submit" name="kategoriProduk"
                                                                    value="{{ $kategori->id }}"
                                                                    style="margin-bottom: 10px;"
                                                                    class="selected">{{ $kategori->nama }}
                                                                    <span>({{ $kategori->produks->where('status_jual', 'aktif')->count() }})</span>
                                                                </button></li>
                                                        @else
                                                            <li><button type="submit" style="margin-bottom: 10px;"
                                                                    value="{{ $kategori->id }}"
                                                                    name="kategoriProduk">{{ $kategori->nama }}
                                                                    <span>({{ $kategori->produks->where('status_jual', 'aktif')->count() }})</span>
                                                                </button></li>
                                                        @endif
                                                    @endforeach
