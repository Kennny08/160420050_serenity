                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-details-content quickview-content">
                                    ...
                                    <div class="pricing-meta">
                                        <ul>
                                            <li class="old-price not-cut">Rp.
                                                {{ number_format($paket->harga, 2, ',', '.') }}</li>
                                        </ul>
                                    </div>

                                    <p class="mt-30px mb-0">{{ $paket->deskripsi }}</p>
                                    <br>
                                    ...
                                    <div class="pro-details-categories-info pro-details-same-style">
                                        <span>Daftar Perawatan : </span><br>
                                        <ul class="ulDetailPaket">
                                            @foreach ($paket->perawatans as $perawatan)
                                                <li class="liDetailPaket">{{ $perawatan->nama }}</li>
                                            @endforeach
                                        </ul>
                                        ...
                                        @if (count($paket->produks) > 0)
                                            ...
                                            <ul class="ulDetailPaket">
                                                @foreach ($paket->produks as $produk)
                                                    <li class="liDetailPaket">{{ $produk->nama }}
                                                        ({{ $produk->pivot->jumlah }})</li>
                                                @endforeach
                                            </ul>
                                        @else
                                            <span>Daftar Produk : -</span>
