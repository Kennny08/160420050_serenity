                                            ...
                                            <div class="login-form-container">
                                                ...
                                                <div class="login-register-form">
                                                    <form action="{{ route('prosesnewpassword') }}" method="POST">
                                                        ...
                                                        @csrf
                                                        <label class="fw-bold h6" style="margin-bottom: 20px;">Kode
                                                            OTP</label>
                                                        <input type="text" name="otp"
                                                            style="border-radius: 5px;font-size: 1.1em;"
                                                            placeholder="Masukkan Kode OTP" required />
                                                        <label class="fw-bold h6"
                                                            style="margin-bottom: 20px;">Password Baru</label>
                                                        <input type="password" name="password" minlength="8"
                                                            style="border-radius: 5px;font-size: 1.1em;"
                                                            placeholder="Masukkan Password Baru" required />
                                                        <label class="fw-bold h6"
                                                            style="margin-bottom: 20px;">Konfirmasi Password
                                                            Baru</label>
                                                        ...
                                                        <div class="button-box">
                                                            ...
                                                            <button style="float: right; border-radius: 5px;"
                                                                type="submit"><span>Konfirmasi</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
