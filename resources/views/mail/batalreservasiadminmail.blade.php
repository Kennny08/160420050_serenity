...
<head>
    ...
    <title>Pembatalan Reservasi dari Salon</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <main>
            <div style="text-align: center;">
                <h2 style="color: whitesmoke;">Pembatalan Reservasi dari Salon
                </h2>
            </div>


            <div style="text-align: center;">
                <h4 style="color: whitesmoke;">Reservasi atas nama {{ $details['pelanggan'] }} dengan nomor nota
                    {{ $details['nomor_nota'] }}
                </h4>
                <h4 style="color: whitesmoke;">{{ $details['pesan'] }}
                </h4>
            </div>
